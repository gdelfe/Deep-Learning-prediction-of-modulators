...
plt.show()
plt.imshow(tensor_hit_trainA[0,:,10:20].transpose(),origin='lower')
plt.show()
...
fig, (ax1,ax2,ax3) = plt.subplots(1,3,figsize=(13,4))
# ax = plt.subplot(111)
my_suptitle = fig.suptitle('CNN - Ch34, 100 random proj, size=46*10, f=[10,30]Hz, 4x4 filters', fontsize=15,y=1.05)
...
# fig.savefig('Plots/NW_46_30/LR_1Ch_100_rand_f_{}_{}_size_46x10.png'.format(fmin,fmax),bbox_inches='tight',bbox_extra_artists=[my_suptitle])
# fig.savefig('Plots/NW_46_30/MLP_1Ch_100_rand_f_{}_{}_size_46x10.png'.format(fmin,fmax),bbox_inches='tight',bbox_extra_artists=[my_suptitle])
fig.savefig('Plots/NW_46_30/CNN_1Ch_100_rand_f_{}_{}_size_46_10_{}_{}_filters.png'.format(fmin,fmax,filter1,filter2),bbox_inches='tight',bbox_extra_artists=[my_suptitle])
plt.close(fig)
